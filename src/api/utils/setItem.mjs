...
export function setItem(data, path) {
  ...
  property {
    ...
    track_type:${
      trackGauge === 13721435
        ? "[TR_1372_DC,TR_1435_DC]"
        : `TR_${trackGauge}_${formatTrackType(current)}`
    }
     ;
    power: 1 kW;
    ...
    purchase: ${data.reuseGfx ? data.reuseGfx : trainName}_purchase;
    cargo_capacity:${capacity};
    ${isDualHeaded ? `purchase_cargo_capacity:${capacity};` : ""}
    loading_speed:${
